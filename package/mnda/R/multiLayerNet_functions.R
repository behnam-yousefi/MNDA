...
## Perform MNDA on multiple networks with two outcomes
## (i.e. individual specific networks - ISNs)
...
#'
mnda_embedding_2layer = function(graph.data, outcome, edge.threshold=0, train.rep=50,
